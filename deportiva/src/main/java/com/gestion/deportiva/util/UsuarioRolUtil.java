...
public class UsuarioRolUtil {
	...
	public UsuarioRolesDTO buildUsuarioRolesDTO(Usuario usuario, List<UsuarioRol> list) {
		...
		retVal.setListUsuarioRolDTO(UsuarioRolUtil.listModelToListDTO(usuario.getListUsuarioRol()));
	...
	public String cleanUrlPageFilter(UsuarioRolFilter filter, String url) {
