...
public class PublicoInstalacionController extends BaseController {
	...
	PublicoInstalacionController(InstalacionService instalacionService, InstalacionTipoService instalacionTipoService,
	...
	private ModelAndView buildListView(InstalacionPublicoFilter filter, Pageable pageable, HttpServletRequest request) {
		...
		mav.addObject("listMunicipio",
				Utils.addEmptyOptionIfMoreThanOneOption(municipioService.getListDTOConSedes(), MunicipioDTO.class));
