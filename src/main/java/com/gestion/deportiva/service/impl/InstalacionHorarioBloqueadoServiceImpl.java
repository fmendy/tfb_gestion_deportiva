...
public class InstalacionHorarioBloqueadoServiceImpl implements InstalacionHorarioBloqueadoService {
	...
	public InstalacionHorarioBloqueadoDTO findById(Long id) {
		...
		return InstalacionHorarioBloqueadoUtil.modelToDTO(instalacionHorarioBloqueadoRepository.findByActivoTrueAndId(id));
	}
	...
	public InstalacionHorarioBloqueadoDTO findByUuid(String uuid) {
		...
		return InstalacionHorarioBloqueadoUtil.modelToDTO(instalacionHorarioBloqueadoRepository.findByActivoTrueAndUuidEqualsIgnoreCase(uuid));
	}
	...
	@Override
	public Page<InstalacionHorarioBloqueadoDTO> getPageByFilter(InstalacionHorarioBloqueadoFilter filter, Pageable pageable) {
		return InstalacionHorarioBloqueadoUtil.pageToPageDTO(instalacionHorarioBloqueadoRepository.findAll(InstalacionHorarioBloqueadoSpecifications.filter(filter), pageable));
	}
	...
	public void eliminar(String uuid) {
		logger.info("Eliminando InstalacionHorarioBloqueado por ID: {}");
		InstalacionHorarioBloqueado model = instalacionHorarioBloqueadoRepository.findByActivoTrueAndUuidEqualsIgnoreCase(uuid);
		model.setActivo(false);
		instalacionHorarioBloqueadoRepository.saveAndFlush(model);
	}
	...
	public List<InstalacionHorarioBloqueadoDTO> getListDTO() {
		return InstalacionHorarioBloqueadoUtil.listModelToListDTO(instalacionHorarioBloqueadoRepository.findByActivoTrue());
	}

	@Override
	public List<InstalacionHorarioBloqueadoDTO> getListDTO(InstalacionHorarioBloqueadoFilter filter) {
		return InstalacionHorarioBloqueadoUtil.listModelToListDTO(instalacionHorarioBloqueadoRepository.findAll(InstalacionHorarioBloqueadoSpecifications.filter(filter)));
	}
